"""
Module containing a class that represents a value function for prediction of synthesisablity of new nodes in the tree search.
"""
...
class ValueFunction:
    """
    Value function implemented as a value neural network for node evaluation (synthesisability prediction) in tree search.
    """
    ...
    def predict_value(self, retrons: List[Retron,]) -> float:
        """
        Predicts a value based on the given retrons from the node. For prediction, retrons must be composed into a
