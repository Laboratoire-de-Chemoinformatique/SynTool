...
class Node:
    ...
    def __init__(
        ...
        :param retrons_to_expand: The tuple of retrons to be expanded.
            The first retron in the tuple is the current retron which
            will be expanded (for which new retrons will be generated by
            applying the predicted reaction rules). When the first
            retron has been successfully expanded, the second retron
            becomes the current retron to be expanded.
        :param new_retrons: The tuple of new retrons generated by
            applying the reaction rule.
        """
    ...
    def __repr__(self) -> str:
        """Returns the SMILES of each retron in retrons_to_expand and
        new_retrons."""
        return (
