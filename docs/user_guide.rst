...
**4. Ranking and filtering policy networks**
...
molecule – on average, this step takes about 10 sec (for several thousand reaction rules). Thus, with limited computational
